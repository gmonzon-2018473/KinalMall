...
public class CuentasPorPagar {
    ...
    public CuentasPorPagar(int codigoCuentaPorPagar, String numeroFactura, Date fechaLimitePago, String estadoPago, Double valorNetoPago, int codigoAdministracion, int codigoProveedor) {
